...
Donate link: https://www.heimkino-praxis.com/movie-database/
...
= 1.0.11 =
* Added the possibility to set a cinema name for screenings – use this if you watched a movie somewhere else, that is not your own home cinema
* Fixed wrong database index definition

= 1.0.10 =
* Fixed a bug in the database schema
* Updated translations

= 1.0.9 =
* Added support for searching after series names
* Added support for searching after guest names within screenings
* Added UHD as new type for sources
* Added streaming as new source type for screenings

= 1.0.8 =
* Fixed a bug where database schema updates would not work because of field comments

= 1.0.7 =
* Allowed part/episode field to accept values greater than 100
