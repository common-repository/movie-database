...
function movdb_sources_page_main ()
{
	...
	<div class="wrap">
		...
		<ul class="subsubsub movdb-category">
			...
			<li class="type-uhd">
				<a class="<?php echo ($filter == 'type_uhd') ? 'current' : ''; ?>" href="admin.php?page=movdb_sources_page&source_filter=type_uhd">
					<?php _e('UHD', 'movdb'); ?>
					<span class="count">(<?php echo $sourcesTable->get_items_type_uhd(); ?>)</span>
				</a>
				|
			</li>
			...
			<ul>
				...
				<li>
					...
					<select id="type" name="type">
						<option value="uhd" <?php echo $args['type'] == 'uhd' ? 'selected' : ''; ?>><?php _e('UHD', 'movdb'); ?></option>
